...
def aggregation_query(
    min_longitude, max_longitude, min_latitude, max_latitude, start_date, end_date, aggregation, api_key
):
    """
...
def construct_aggregation_dict(agg_functions, vars_3d, vars_4d, heights):
    ...
    for function in agg_functions:
        aggregation_dict[function] = {"4DVars": vars_4d, "3DVars": vars_3d, "zHeights": heights}
...
def construct_aggregation_dict_open(agg_functions, vars_3d_list, vars_4d_list, heights_list):
    ...
    for i, function in enumerate(agg_functions):
        aggregation_dict[function] = {"4DVars": vars_4d_list[i], "3DVars": vars_3d_list[i], "zHeights": heights_list[i]}
    return aggregation_dict
