...
def threshold_query(min_longitude, max_longitude, min_latitude, max_latitude, start_year, end_year, height, filtering_thresholds, api_key):
  """
...
filtering_thresholds = {
 "wsp_min":4,"wsp_max":16, # Wind speed in m/s
 "tc_min":0,"tc_max":22, # Temperature in Celsius
...
response = threshold_query(min_longitude, max_longitude, min_latitude, max_latitude, start_year, end_year, height, filtering_thresholds, api_key)
